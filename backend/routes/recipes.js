        ...
        database.sessionToEmployeeID(session_id).then((employee_id) => {
            if (employee_id) {
                ...
                const query = `
                    ...
                    WHERE rim.RecipeID = '${recipeId}' -- Directly inserting recipeId
                `;
...
app.post('/add_recipe', async (req, res) => {
    ...
    const query = `INSERT INTO tblRecipes (RecipeID, RecipeName, Description, Category, PrepTime, CookTime, Servings,
                                           Instructions, CreatedAt)
                   VALUES ('${recipeID}', '${req.body.RecipeName}', '${req.body.Description}', '${req.body.Category}',
                           '${req.body.PrepTime}', '${req.body.CookTime}', '${req.body.Servings}',
                           '${req.body.Instructions}', GETDATE())`;
